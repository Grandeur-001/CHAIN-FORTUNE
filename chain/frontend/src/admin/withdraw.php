    ...
    <main class="main" id="main">
        <div class="app-container">
            <div class="deposit-container">
                <h1>Select Crypto Wallet and make withdrawal</h1>
                <p>
                    Choose a cryptocurrency wallet to withdraw funds from. Select a wallet from the grid below and enter the amount you wish to withdraw in USD. 
                    <br>
                    <span style="color: var(--secondary-text-clr);"><b>Note:</b> Make sure to enter your active/valid crypto wallet address</span>
                </p>
                <div class="content">
            ...
            <div class="inputs-container">
                ...
                <input type="text" id="wallet-address" placeholder="Enter wallet address" value="">
                ...
                <input type="number" id="deposit-amount" placeholder="Amount in USD" value="">
                <button class="deposit-btn" id="withdraw-btn" type="button">Withdraw</button>
            </div>
