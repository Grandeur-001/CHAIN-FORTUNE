    ...
    <main class="main" id="main">
        <div class="app-container">
            <div class="deposit-container">
                ...
                <p>
                    This page allows you to credit all users with a specific amount of cryptocurrency.
                    <br>
                    <span style="color: var(--secondary-text-clr);"><b>Note:</b>
                    Please ensure you have sufficient balance in your wallet before proceeding. The amount will be credited in the selected cryptocurrency.</span>
                    </span>
                </p>
                <div class="content">
            ...
            <div class="inputs-container">
                ...
                <label for="credit-amount">Amount to credit*</label>
                <input type="number" id="credit-amount" placeholder="Amount in USD" value="">
                <button class="deposit-btn" id="credit-btn" type="button">Credit all users</button>
            </div>
    ...
    <script>
        $(function() {
            ...
            $('#credit-btn').on('click', function() {
                ...
                setTimeout(() => {
                    $.ajax({
                        url: '/chain-fortune/action/credit_users_logic',
                        method: 'POST',
                        data: {
                            user_id: userId,
                            amount: amount,
