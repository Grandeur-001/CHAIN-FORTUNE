...
<body>
    ...
    <main class="main" id="main">
      <div class="app-container">
        ...
        <?php
            ...
            $name = htmlspecialchars($_SESSION['deposit_crypto_name']);
            $symbol = htmlspecialchars($_SESSION['deposit_crypto_symbol']);
            $walletAddress = htmlspecialchars($_SESSION['deposit_wallet_address']);
            $qrCode = htmlspecialchars($_SESSION['deposit_qr_code']);
            $icon = htmlspecialchars($_SESSION['deposit_icon']);
            $amount = $_SESSION['deposit_amount'];

            echo(<<<HTML
               <div style="text-align: center; margin-bottom: 30px;">
                    <h1>Deposit to Your $name Wallet</h1>
                    <p>To complete your deposit, please send the specified amount to the wallet address below.</p>
                    <p>Once the payment is confirmed, your account will be credited with the deposited amount.</p>
               </div>
                <div class="payment-container">
                    <div class="card">
                        ...
                        <div class="info-row">
                            ...
                            <div class="info-value amount-value" id="depositAmount">$amount USD</div>
                        </div>
                    </div>
    ...
    <script>
        ...
        $('#pay-btn').on('click', function() {
            ...
            $.ajax({
                url: '/chain-fortune/action/handle_deposit',
                type: 'POST',
                data: {
                    user_id: userId,
