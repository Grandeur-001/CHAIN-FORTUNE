    ...
    <main class="main" id="main">
        <div class="app-container">
            <div class="deposit-container">
                ...
                <p>
                    Choose a cryptocurrency wallet to deposit funds. Select a wallet from the grid below and enter the amount you wish to deposit in USD. 
                    <br>
                    <span style="color: var(--secondary-text-clr);"><b>Note:</b> The wallet address is auto-generated and cannot be changed.</span>
                </p>
                <div class="content">
            ...
            <div class="inputs-container">
                ...
                <input type="text" id="wallet-address" placeholder="No wallet address selected" value="" disabled>
                ...
                <button class="deposit-btn" id="deposit-btn" type="button">Deposit</button>
            </div>
